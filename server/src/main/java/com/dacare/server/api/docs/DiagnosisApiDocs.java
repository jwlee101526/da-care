...
@Tag(name = "AI 진단", description = "SSE 기반 기기 증상 상담")
public interface DiagnosisApiDocs {
  ...
  @ApiResponses({
      @ApiResponse(responseCode = "200", description = "SSE 스트림 연결 완료", content = @Content(
  ...
  SseEmitter stream(@io.swagger.v3.oas.annotations.parameters.RequestBody(required = true,
      content = @Content(schema = @Schema(implementation = QuestionRequest.class), examples = @ExampleObject("""
